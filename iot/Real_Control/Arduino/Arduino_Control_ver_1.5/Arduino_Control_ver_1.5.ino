...
char recieved_value1;
char recieved_value2;
...
//=================================무게 센서 제어=================================//
    ...
    if(timer1++ == 0){
      while(1){
        if(Serial.available() > 0){
          recieved_value1 = Serial.read();
          break;
        }
      }
      if(recieved_value1 == 'a'){
        innerCount1 = 0;
        servo1.write(angle1 - 114);
      }
      else{ // recieved_value1 == 'r'
        flag1 = false;
        timer1 = 0;
      }
    }else if(timer1 == 12){
  ...
  if(flag2) {
    ...
    if(timer2++ == 0){
      while(1){
        if(Serial.available() > 0){
          recieved_value2 = Serial.read();
          break;
        }
      }
      if(recieved_value2 == 'a'){
        innerCount2 = 0;
