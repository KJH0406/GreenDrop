...
function AdminMain() {
  ...
  let [todayStatus, setTodayStatus] = useState([
    { question: "" },
    { leftAnswer: "" },
    { rightAnswer: "" },
    { leftCount: "" },
        ...
        setTodayOptions((todaySeries) => {
          return {
            ...
            options: {
              ...todaySeries.options,
              labels: [
                `1번 선택지 : ${result.data.leftCount}개`,
                `2번 선택지 : ${result.data.rightCount}개`,
              ],
            },
          };
        });
    ...
    <div className={classes.admin_main_container}>
      <div className={classes.today_section}>
        <div className={classes.today_chart}>
          {todayStatus[4].rightCount + todayStatus[3].leftCount !== 0 ? (
            <ReactApexChart
              options={todayOptions.options}
              series={todayOptions.series}
              type="donut"
              width="100%"
              height="100%"
            ></ReactApexChart>
        ...
        <div className={classes.balance_game}>
          <div className={classes.text_section}>
            ...
            <div className={classes.question}>{todayStatus[0].question}</div>
          </div>
          <div className={classes.text_section}>
      ...
      <div className={classes.chart_section}>
        <div className={classes.chart}>
          <div className={classes.chart_title}>수거현황</div>
          <hr />
